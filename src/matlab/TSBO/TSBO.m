...
adams_model = @(value) -1*adams_model(value);
...
% f = ukf ; dimension=6; sample_space = [10e-8, 1; 10e-8, 1; 100, 2000; 100, 2000; 10e-8, 1; 10e-8, 15;];
% f = ukf ; dimension=6; sample_space = [10e-8, 1; 100, 50000; 100, 2000; 100, 2000; 100, 50000; 10e-8, 15;];
f = adams_model; dimension=4; sample_space = [0.02, 1.5; 10, 400; 0.95, 5; 0.7, 2];
...
N_switching_count = 35;  

count_max = 70; %maximum number of function evaluations(simulations)
N_acq_train = 45; %Number of simulations to be used for Learning Acquisition functions block
...
plot(1:1:length(best_samples),flip(best_samples),'-b','LineWidth',3)
% h.FontWeight = 'bold';
h.FontSize = 24;
